...
// Note for the E value if you change the hobbed part and/or need to do the calculations for a new value
// e_steps_per_unit = (motor_steps_per_rev * driver_microstep) *(big_gear_teeth / small_gear_teeth) / (hob_effective_diameter * pi)
// USUALLY          =        200                   16                  45               11                       5              3.1415.....
// Uncomment to enable geared Extruder
//#define E_STEPS_PER_UNIT 759.3

// Default Prusa i3 Extruder Steps Per Unit(mm) (Comment it out if using geared extruder)
//#define E_STEPS_PER_UNIT 161.3

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,759.3}
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 12, 500}    // (mm/sec)
...
#define LOAD_FILAMENT_1 "G1 E550 F1000"
#define LOAD_FILAMENT_2 "G1 E40 F100"

// Unload filament commands
#define UNLOAD_FILAMENT_0 "M83"
#define UNLOAD_FILAMENT_1 "G1 E-550 F7000"
...
// I assume this means the value 0-255 in the comments above are calculated as follow:
// DEFAULT_PWM_MOTOR_CURRENT * 255 / 2000 = A number between (0~255) and converted to Amps as Above
#if MOTHERBOARD == 102 || MOTHERBOARD == 302
#define MOTOR_CURRENT_PWM_RANGE 2000
#define DEFAULT_PWM_MOTOR_CURRENT  {540, 900, 500} // {XY,Z,E}
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 900, 500} // {XY,Z,E}
#endif
